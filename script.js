$(document).ready(function() {
  const apiRoot = 'https://kodilla2-prod-kodilla-tasks-65mp5r.mo2.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://kodilla2-prod-kodilla-tasks-65mp5r.mo2.mogenius.io/v1/trello';
